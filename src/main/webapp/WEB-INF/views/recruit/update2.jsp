                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-footer">
                            <div class="btn-group btn-group-justified">
                                ...
                                <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#recruitJobAddModal">채용 직무 추가</a>
                            </div>
                        </div>
                                ...
                                <table class="table table-hover">
                                    ...
                                    <c:forEach varStatus="i" var="recruitJobs" items="${recruitJobs}">
                                        <tr class="recruitJob">
                                            ...
                                            <td>
                                                <select class="form-control" id="recruitJobCategory2${i.index}" name="jobCategory2Id">
                                                </select>
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" id="recruitJobDetail" name="recruitJobDetail" placeholder="예) 자바개발자" value="${recruitJobs.recruitJobDetail}">
                                            </td>
                                            <td>
                                                <select class="form-control" id="recruitJobType${i.index}" name="recruitJobType">
                                                    <option value="">:::선택:::</option>
                                                    <option value="인턴">인턴</option>
                                                    <option value="계약직">계약직</option>
                                                    <option value="신입">신입</option>
                                            ...
                                            <td>
                                                <select class="form-control" id="recruitJobEdu${i.index}" name="recruitJobEdu">
                                                    <option value="">:::선택:::</option>
                                                    <option value="학력무관">학력무관</option>
                                                    <option value="전문대졸">전문대졸</option>
                                                    <option value="대졸">대졸</option>
                                                ...
                                                <div class="modal fade" id="articleUpdateModal${i.index}" tabindex="-1" role="dialog" aria-labelledby="articleUpdateModalLabel">
                                                    <div class="modal-dialog modal-lg" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form role="form" id="articleUpdateForm" method="post" action="">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <button type="button" class="btn btn-primary" id="companyInfoUpdateBtn">저장
                                                                </button>
                                                            </div>
